package udacity.popular_movie_stage1.Fragments;
...
import udacity.popular_movie_stage1.HelperMethods;
import udacity.popular_movie_stage1.MovieDetail;
import udacity.popular_movie_stage1.MovieDetailsActivity;
import udacity.popular_movie_stage1.MovieListAdapter_HomeActivity;
import udacity.popular_movie_stage1.R;
import udacity.popular_movie_stage1.Utils.JsonUtils;
import udacity.popular_movie_stage1.Utils.NetworkUtils;
import udacity.popular_movie_stage1.ViewModel.FragmentViewModel;

public class TopRatedMoviesFragement extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<MovieDetail>>,
    ...
    //Empty Constructor
    public TopRatedMoviesFragement() {
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        movieDatabase = DataBase.getIsInstance(getContext());
    ...
    public Loader< ArrayList<MovieDetail> > onCreateLoader(int id, @Nullable final Bundle args) {
        ...
        return new AsyncTaskLoader< ArrayList<MovieDetail> >(Objects.requireNonNull(getContext())) {
            ...
            protected void onStartLoading() {
                ...
                Log.d("TopRated Movies Page No", String.valueOf(currentPage));
    ...
    private void showToastMessage() {
        ...
        if (mToast != null){
            ...
            //mToast = Toast.makeText(getContext(),"Check your Internet Connection.",Toast.LENGTH_SHORT);
            mToast.show();
        }else {
            mToast = new Toast(getContext());
            mToast.setGravity(Gravity.BOTTOM, 0, 0);
    ...
    public boolean isNetworkAvailable(){
        ConnectivityManager connectivityManager = (ConnectivityManager) Objects
