...
public class UpComingMoviesFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<MovieDetail>>,
    ...
    public Loader< ArrayList<MovieDetail> > onCreateLoader(int id, @Nullable final Bundle args) {
        ...
        return new AsyncTaskLoader< ArrayList<MovieDetail> >(Objects.requireNonNull(getContext())) {
            ...
            protected void onStartLoading() {
                ...
                Log.d("Upcoming Movies Page No", String.valueOf(currentPage));
