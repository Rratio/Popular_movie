...
import udacity.popular_movie_stage1.AppExecutors;
import udacity.popular_movie_stage1.DataBase;
import udacity.popular_movie_stage1.FavoriteMoviesAdapter;
...
import udacity.popular_movie_stage1.ViewModel.FavoriteMoviesViewModel;
            ...
            case R.id.img_favorite_recycerView_Card_HomeActivity:
                if (movieEntries.size() > 0) {
                    ...
                    AppExecutors.getInstance().executorForDatabase().execute(new Runnable() {
                        @Override
                        public void run() {
                            movieDatabase.userDao().deleteMovie(movieEntries.get(clickedMoviePosition));
