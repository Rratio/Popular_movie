...
class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.ReviewsViewHolder> {
    ...
    public ReviewAdapter(ArrayList<MovieReviews> movieReviews, int totalReviews, Context context) {
