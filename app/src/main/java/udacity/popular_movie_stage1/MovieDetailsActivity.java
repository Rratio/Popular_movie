...
import udacity.popular_movie_stage1.Utils.JsonUtils;
import udacity.popular_movie_stage1.Utils.NetworkUtils;
import udacity.popular_movie_stage1.ViewModel.FavMovieDetailsViewModel;
import udacity.popular_movie_stage1.ViewModel.FavMovieDetailsViewModelFactory;
import udacity.popular_movie_stage1.ViewModel.MovieDetailsViewModel;
import udacity.popular_movie_stage1.ViewModel.MovieDetailsViewModelFactory;
...
public class MovieDetailsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Database
        movieDatabase = DataBase.getIsInstance(getApplicationContext());
            ...
            case R.id.img_btn_favorite:
                ...
                if (fromFavorite) {
                    ...
                    AppExecutors.getInstance().executorForDatabase().execute(new Runnable() {
                        @Override
                        public void run() {
                            movieDatabase.userDao().deleteMovie(movieEntry);
                            movieDatabase.userDao().deleteCasts(movieID);
                            movieDatabase.userDao().deleteTrailers(movieID);
                            movieDatabase.userDao().deleteReviews(movieID);
                        }
                    });
   ...
   */
    ...
    private void setMovieReviewsRecyclerView() {
        ...
        if (movieReviews.size()>0) {
            ...
            reviewsAdapter = new ReviewAdapter(movieReviews, movieReviews.size(), this);
   ...
   */
    ...
    */
    private void loadReviewsIntoDatabase() {
        ...
        movieDatabase.userDao().insertReviews(reviewsEntry);
    }
    ...
    private void loadTrailersIntoDatabase() {
        ...
        movieDatabase.userDao().insertTrailers(trailerEntries);
    }
    ...
    private void loadCastsIntoDatabase() {
        ...
        movieDatabase.userDao().insertCasts(castEntries);
    ...
    private void loadMovieDetailsIntoDatabase() {
        ...
        movieDatabase.userDao().insertMovie(movieEntry);
    }
}